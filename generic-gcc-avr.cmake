...
##########################################################################
#
# AVR_TOOLCHAIN_HOME - environment variable defining path to TOOLCHAIN
...
# executables in use
##########################################################################
message(STATUS "Current OS: " ${CMAKE_HOST_SYSTEM_NAME})

if (DEFINED ENV{AVR_TOOLCHAIN_HOME})
    set(COMPILERS_PATH $ENV{AVR_TOOLCHAIN_HOME}/bin)
    set(LIBS_PATH $ENV{AVR_TOOLCHAIN_HOME}/avr)
elseif(EXISTS "/usr")
    set(COMPILERS_PATH "/usr/bin")
    set(LIBS_PATH /usr/lib/avr)
else(DEFINED ENV{AVR_TOOLCHAIN_HOME})
    message(FATAL_ERROR "AVR_TOOLCHAIN_PATH was not found in your system!")
    message(FATAL_ERROR "Please set AVR_TOOLCHAIN_PATH variable in your environment (AVR_TOOLCHAIN_HOME for example) or install AVR_TOOLCHAIN in right manner via Linux package manager.")
endif (DEFINED ENV{AVR_TOOLCHAIN_HOME})
find_program(AVR_CC ${COMPILERS_PATH}/avr-gcc)
find_program(AVR_CXX ${COMPILERS_PATH}/avr-g++)
find_program(AVR_OBJCOPY ${COMPILERS_PATH}/avr-objcopy)
find_program(AVR_SIZE_TOOL ${COMPILERS_PATH}/avr-size)
find_program(AVR_OBJDUMP ${COMPILERS_PATH}/avr-objdump)

if(AVR_CC)
    message(STATUS "Current AVR-GCC compiler is: avr-gcc")
else(AVR_CC)
    message(FATAL_ERROR "AVR-GCC compiler was not found in your system.")
endif(AVR_CC)
if(AVR_CXX)
    message(STATUS "Current AVR-C++ compiler is: avr-g++")
else(AVR_CXX)
    message(FATAL_ERROR "AVR_C++ was not found in your system!")
endif(AVR_CXX)
if(AVR_OBJCOPY)
    message(STATUS "Current AVR_OBJCOPY is: avr-objcopy")
else(AVR_OBJCOPY)
    message(FATAL_ERROR "AVR_OBJCOPY was not found in your system!")
endif(AVR_OBJCOPY)
if(AVR_SIZE_TOOL)
    message(STATUS "Current AVR_SIZE_TOOL is avr-size")
else(AVR_SIZE_TOOL)
    message(FATAL_ERROR "AVR_SIZE_TOOL was not found in your system!")
endif(AVR_SIZE_TOOL)
if(AVR_OBJDUMP)
    message(STATUS "Current AVR_OBJDUMP is: avr-objdump")
else(AVR_OBJDUMP)
    message(FATAL_ERROR "AVR_OBJDUMP was not found in your system!")
endif(AVR_OBJDUMP)
...
##################################################################################
set(CMAKE_FIND_ROOT_PATH ${LIBS_PATH})
...
if(NOT EXISTS ${CMAKE_SYSTEM_INCLUDE_PATH})
    message(FATAL_ERROR "PATH TO AVR HEADERS does not exist in your system!")
endif()

if(NOT EXISTS ${CMAKE_SYSTEM_LIBRARY_PATH})
    message(FATAL_ERROR "PATH TO AVR LIBRARIES does not exist in your system!")
endif()
...
if(CMAKE_BUILD_TYPE MATCHES RelWithDebInfo)
    set(CMAKE_C_FLAGS_RELWITHDEBINFO "-Os -save-temps -g -gdwarf-2 -gstrict-dwarf")
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-Os -save-temps -g -gdwarf-2 -gstrict-dwarf")
endif(CMAKE_BUILD_TYPE MATCHES RelWithDebInfo)

if(CMAKE_BUILD_TYPE MATCHES Debug)
    set(CMAKE_C_FLAGS_DEBUG "-Os -save-temps -g -gdwarf-2")
    set(CMAKE_CXX_FLAGS_DEBUG "-Os -save-temps -g -gdwarf-2")
